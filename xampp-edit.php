...
Click on apache > config > Apache (httpd.conf) enter image description here
...
After that open apache > config > Apache (httpd-xampp.conf) enter image description here
